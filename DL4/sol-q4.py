...
def build_rnn_model(window_size):
    ...
    model.add(layers.SimpleRNN(20, input_shape=(window_size, 1))) # 50x1
...
def build_deep_rnn_model(window_size):
    ...
    # 단일 벡터만 반환(batch_size, units) return_sequences= False
    # 스텝마다 모두 반환(시퀀스-to-시퀀스, batch_size, timesteps, units) return_sequences = True
